...
type AttributeNodeData = RouterOutput["admin"]["attributes"]["queries"]["getAll"][number];

export function AttributeNode(props: NodeProps<Node<AttributeNodeData>>) {
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Card className="hover:border-primary relative w-80 cursor-pointer transition-all hover:shadow-sm">
          <Badge className="bg-background absolute right-2 top-2 gap-1 font-medium">
