...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      <MaxWidthWrapper className="flex h-screen flex-col items-center justify-center py-32 md:py-48">
      ...
      <div className="absolute inset-x-0 -bottom-1/2 -z-10 h-full opacity-80">
